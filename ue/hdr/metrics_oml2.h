...
/******************************************************************************
 * File:        metrics_oml2.h
 * Description: Metrics class using OML2 for instrumentation.
 *****************************************************************************/

#ifndef METRICS_OML2_H
#define METRICS_OML2_H
...
public:
  ...
  bool init(ue_metrics_interface *u, float report_period_secs, int argc, char *argv[]);
  void stop();
